...
//global variables 
int a[] = {100,30,80,70,90,50,20,40,10,60};
int n=10;

int main ()
{
    //calling the shell sort function which has  sorted the array
    shell_sort();
...
void shell_sort (void)
{
    ...
    */
    ...
    for( gap = n/2 ; gap >=1 ; gap = gap/2 )
    {
       ...
       //shifting elements in multiple gaps
       for( i = gap ; i < n ; i++)
       {
